...
2. Once approved by the maintainers, **you will automatically receive an invitation** granting you access to the development repository with full setup instructions.
